...
%, bb =0 0 730px 713px    , bb=0 0 478px 321px        , bb=0 0 517px 388px
...
\subsection{\ac{OCS}}
\label{ss:ocs}
The thruster needed for \ac{OCS} needs to be able to deliver the $\Delta V$ determined in section \ref{mtrOrbAltitude}. The $\Delta V$ a propulsion system can produce is quantified by Tsiolkovsky's rocket equation
...
Depending on the altitude of the satellite orbit a thruster for attitude keeping can be selected in a later stage of the design \cite{larson}.
...
& \includegraphics[height = 120px]{chapters/img/imi100attitude.png} 
\end{array}$
\caption[\acs{ACS} design concepts]{The three concepts for the design of the \ac{ACS}. From left to right: Concept 1 uses thrusters \cite{tnoweb}, concept 2 uses reaction wheels and magneto torquers \cite{cubesatshop}, concept 3 uses IMI-100 system from Maryland Inc. \cite{imi100}.}

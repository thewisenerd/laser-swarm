...
& The analysis in chaper >>>> reference 

to receiver shows that the laser should have a wavelength in the interval of 425 - 500 nm (within visible spectrum designated as 'blue'). Hence, every \acs{laser} with different wavelengths are not viable for this analysis. 

Potential \acs{laser} types for this altimetry mission:

\itshape{Helium-Cadmium (He-Cd) \acs{laser}}
Wavelength: 441.6 [nm]
Gain medium type: Gas

\itshape{Neodymium-doped Yttrium Aluminium (Nd-YAG) \acs{laser}}
Wavelength: 946 [nm] (473 [nm] with frequency doubling)
Gain medium type: Solid-State

\itshape{Argon (Ar) \acs{laser}}	
Wavelength: 454.6 [nm]
Gain medium type: Gas

\itshape{\acs{laser} diode sytems
...
Table &reference shows the trade-off for the different \acs{laser}s. The most important  criteria and the ones that clearly need some explanation, are discussed in more detail in this section for the different gain media. 
...
\itshape{Helium-Cadmium}
Pumping efficiency: 0.82
Upper \acs{laser} level lifetime [s]: 7.1 * 10^-7
Round trip power losses [10^-28 W]: 2.357 
Stimulated emission cross section [m^2]: 9.0 * 10^-18

Minimum Pump Power [mW]: 45 

\itshape{Nd-YAG}
Pumping efficiency: 0.92
Upper \acs{laser} level lifetime [s]: 2.30 * 10^-6
Round trip power losses [10^-28 W]: 5.01
Stimulated emission cross section [m^2]: 2.8 * 10^ -23

Minimum Pump Power [mW]: 75

\itshape{Argon}
Pumping efficiency: 0.82
Upper \acs{laser} level lifetime: 1.0 * 10^-8
Round trip power losses:  2.787
Stimulated emission cross section [m^2]: 2.6 * 10^-16

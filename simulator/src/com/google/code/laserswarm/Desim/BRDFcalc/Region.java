...
public class Region {
	...
	/**
	 * 
	 * @param recMap	Map of the receivers  relative to the origin of the footprint and the amount of photons
	 * @param loc		Location pointing to the origin of the footprint in ECEF
	 * @param emVec		Position of the emitter relative to the base of the footprint ;
	 * @param atSl		Along track slope
	 * @param otSl		Off track slope
	 * @param trDir		Vector in ENU indicating the direction of movement of the emitter (along track vector)
	 */
	public void add(Map<Vector3d,Integer> recMap,  Vector3d emVec, double atSl, double otSl, Vector3d trDir) {

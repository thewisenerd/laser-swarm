...
/**
 * Class that contains the information needed by the FindBRDF class.
 * All information corresponds to an instance in time.
 * 
 *
 */
public class BRDFinput {
	...
	public Map<Vector3d, Double> getRecVecsECI() {
		return recVecsECI;
	}
	...
	public BRDFinput(Vector3d emPos, Vector3d emDir, double alongSlope, double offSlope,
			Map<Vector3d, Double> recVecsECI, double curTime) {
	...
	double offSlope ;
	/**
	 * Map of positions (at the time of receiving) of receivers and number of non-noise photons received (positive real number).
	 * Vectors are in ECI.
	 */
	Map<Vector3d,Double> recVecsECI; 
	/**

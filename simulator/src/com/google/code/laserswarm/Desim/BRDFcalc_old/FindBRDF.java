...
public class FindBRDF {
	...
	private Region				defRegion;
	private List<Region>		region;
	private OrbConv				conv;
	 ...
	 * 
	 * @param emVec
	 *            ECI vector for emitter with altitude subtracted (points to the base of the plane )
	 * @param recVecs
	 *            ECI vector for receivers
	 */
	public void add(Vector3d emVecECI, Map<Vector3d, Double> recVecsECI, double t_cur) {
		// convert emVec to ECEF
		// convert recVecs to ECEF to ENU see

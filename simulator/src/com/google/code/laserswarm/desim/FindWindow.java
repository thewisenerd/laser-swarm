...
public class FindWindow {
	...
	private EmitterHistory						hist;
	private Iterator<Double>					timeIt;
	/**
	 * satellite - timeline map
	 */
	private Map<Satellite, TimeLine>			satData;
	/**
	 * satellite - sampleiterator map
	 */
	private Map<Satellite, SampleIterator>		satIter;
	/**
	...
	/**
	 * map that contains initial data
	 */
	private Map<Satellite, MeasermentSample>	satMsMap;

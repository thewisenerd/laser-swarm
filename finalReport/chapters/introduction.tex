...
The purpose of this project was to explore this last alternative, in order to fulfill a similar mission to ICESat's: monitoring changes that take place at the surface of the Earth.
...
The introduction should say a bit more about the purpose of the mission, for example “monitoring of our changing earth”: glaciers, deforestation, desertification, urban expansion. Al this can be seen from range measurements that include height distributions within footprints (full wave form recordings). Confusion is caused at slopes, which is expected to improved my measuriong BRDF.

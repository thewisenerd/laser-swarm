...
\left(\frac{exp\left[-i(kz + \psi(z))\right]}{w_{0R}(z)\sqrt{\left[1 + \left(\frac{z\lambda M^{2}}{\pi w_{0R}^{2}}\right)^{2}\right]}}\right)exp\left[\frac{-(x^{2}+y^{2})}{\left[w_{0R}\sqrt{\left[1 + \left(\frac{z\lambda M^{2}}{\pi w_{0R}^{2}}\right)^{2}\right]}\right]^{2}}-\frac{ik(x^{2}+y^{2})}{2z\left[1 + \left(\frac{\pi w_{0R}^{2}}{z\lambda M^{2}}\right)^{2}\right]}\right]\right)

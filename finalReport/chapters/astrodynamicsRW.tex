...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.65\textwidth, angle=0]{chapters/img/Shock_Loads_Acceleration.png}
...
\begin{figure}[ht!]
  \centering
  \subfloat[]{\label{fig:elecMax}\includegraphics[width=0.4\textwidth]{chapters/img/collA.png}}                
  \subfloat[]{\label{fig:elecMin}\includegraphics[width=0.4\textwidth]{chapters/img/collB.png}}\\
  \subfloat[]{\label{fig:elecMin2}\includegraphics[width=0.4\textwidth]{chapters/img/collC.png}}
